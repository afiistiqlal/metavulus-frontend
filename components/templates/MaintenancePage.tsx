...
import Wave from "/public/images/maintenanceWave.png";
...
const MaintenancePage = (props: Props) => {
  return (
    <Layout>
      <div className="flex min-w-full min-h-screen max-h-fit">
        <div className="py-8 px-10 flex flex-col gap-4 w-2/4 z-10">
          <Link href={"#"}>
            <Image
        ...
        <Image
          src={Wave}
          alt="wave"
          className="absolute top-o overflow-hidden max-w-full max-h-full"
        />
      </div>
    </Layout>
  );

...
const HomeFooter = (props: Props) => {
  ...
  return (
    <div className="w-full bg-white rounded-t-[70px] shadow-[5px_-5px_60px_-15px_rgba(0,0,0,0.3)] py-10">
          ...
          <div className="lg:w-3/12 flex flex-col gap-5">
            ...
            <div className="w-9/12">
              <p className="font-QuicksandMedium text-[#ABABAB] text-[18px] leading-[22px]">
                Jl Jend Gatot Subroto Bl II/7 Kawasan Industri Candi, Jawa
                Tengah
              </p>
            </div>
          </div>
          <div className="w-9/12 flex flex-col">
            <div className="w-full flex flex-col mt-10 lg:mt-0 lg:flex-row justify-end gap-5 lg:gap-14 ">
